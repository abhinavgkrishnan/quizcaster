...
export default function FriendsList({ user, onNavigate, currentScreen }: FriendsListProps) {
  ...
  return (
    <div className="w-full h-screen flex flex-col bg-card overflow-hidden">
      ...
      <div className="flex-none bg-secondary border-t-2 border-black flex flex-col relative z-10" style={{ maxHeight: 'calc(40vh - 80px)' }}>
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-24 space-y-2" style={{ WebkitOverflowScrolling: 'touch' }} onScroll={handleFollowersScroll}>
        {platform === 'world' ? (
